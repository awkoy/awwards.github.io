...
var _times = __webpack_require__(50);
...
var Common = exports.Common = function () {
  ...
  function Common() {
    ...
    if (_helpers.Resp.isDesk) {
      ...
      (0, _jquery2.default)('.js-tilt').tilt({
        scale: 1.03,
        maxTilt: 4
      });
    }
    (0, _jquery2.default)(".anchor").click(function () {
      (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)(this.getAttribute('href')).offset().top
      }, 'slow');
    });
    this.init();
  }
    ...
    value: function animateSnow() {
      var Snow = function Snow(canvas, count) {
        ...
        var update = function update() {
          return (0, _forEach2.default)(snowflakes, function (el) {
            return el.update();
          });
        };
        ...
        var resize = function resize() {
          ...
          (0, _forEach2.default)(snowflakes, function (el) {
            return el.resized();
          });
        };
        ...
        var init = function init() {
          (0, _times2.default)(count, function () {
      ...
      background.src = './static/img/star.svg';
      ...
      var SnowItem = function SnowItem(canvas) {
        ...
        var params = {
          background: background,
          x: (0, _random2.default)(0, canvas.offsetWidth),
          y: (0, _random2.default)(-canvas.offsetHeight, 0),
          radius: _random2.default.apply(undefined, _toConsumableArray(radius)),
          speed: _random2.default.apply(undefined, _toConsumableArray(speed)),
          wind: _random2.default.apply(undefined, _toConsumableArray(wind)),
          isResized: false
        };
        var ctx = canvas.getContext("2d");

        var updateData = function updateData() {
          params.x = (0, _random2.default)(0, canvas.offsetWidth);
          params.y = (0, _random2.default)(-canvas.offsetHeight, 0);
        };
        ...
        var drawDefault = function drawDefault() {
          ctx.drawImage(background, params.x, params.y, params.radius, params.radius);
        };
...
var baseRandom = __webpack_require__(19),
    isIterateeCall = __webpack_require__(20),
    toFinite = __webpack_require__(11);
